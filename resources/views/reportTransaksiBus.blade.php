...
<html>
<head>
	<title>Laporan Transaksi Sewa Bus</title>
	...
	<table>
		<thead>
			<tr>
				...
				<th width="70%">
				<h5 align="center">Laporan Transaksi Sewa Bus</h5>
	...
	<table class='table table-bordered'>
		...
		<tbody>
				...
				<tr>
					...
					<td>{{$dt->dataKatalogBus->nama_bus}}</td>
					<td>{{$dt->jumlah_hari}}</td>
					<td>{{$dt->dataKatalogBus->tujuanWilayah->tujuan}}</td>
